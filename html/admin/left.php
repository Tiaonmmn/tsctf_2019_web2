  ...
  <tr>
	...
	<li><a href="dl_manage.php" target="frmright"><?php echo channeldl?></a></li>
     ...
     <div id="left1" style="display:none"> 
	  <li><a href="tag.php?tablename=caicaicms_tagzs" target="frmright">关键词</a><a href="zs_manage.php" target="frmright"><?php echo channelzs?></a></li>
	...
	<li><a href="pinglun_manage.php" target="frmright">评论</a>
		<a href="tag.php?tablename=caicaicms_tagzx" target="frmright">关键词 </a>
	...
	?>
	  ...
	  <li><a href="class2.php?tablename=caicaicms_zsclass" target="frmright"><?php echo channelzs?>/<?php echo channeldl?>类别</a></li>
	 <?php
	if (str_is_inarr(channel,'zx')=='yes'){
	?>
	  <li><a href="class2.php?tablename=caicaicms_zxclass" target="frmright">资讯类别</a></li>
	  <?php
	}
	if (str_is_inarr(channel,'special')=='yes'){
	?>
	   <li><a href="class2.php?tablename=caicaicms_specialclass" target="frmright">专题类别</a></li>
	   <?php
	}
	if (str_is_inarr(channel,'job')=='yes'){
	?>
	  <li><a href="class2.php?tablename=caicaicms_jobclass" target="frmright">招聘类别</a></li>
	<?php
	}
	if (str_is_inarr(channel,'ask')=='yes'){
	?>
	  <li><a href="class2.php?tablename=caicaicms_askclass" target="frmright">问答类别</a></li>
	    <?php
	}
	if (str_is_inarr(channel,'zh')=='yes'){
	?>  
      <li><a href="class.php?tablename=caicaicms_zhclass" target="frmright">展会类别</a></li>
	  <?php
	}
	if (str_is_inarr(channel,'wangkan')=='yes'){
	?>
	  <li><a href="class.php?tablename=caicaicms_wangkanclass" target="frmright">网刊类别</a></li>
	  <?php
	}
	
	
	?>
	<li><a href="class2.php?tablename=caicaicms_userclass" target="frmright">企业类别</a></li>
      <li><a href="adclass.php" target="frmright">广告类别</a></li> 
	<li><a href="class.php?tablename=caicaicms_linkclass" target="frmright">友情链接类别</a></li>
      </div>
