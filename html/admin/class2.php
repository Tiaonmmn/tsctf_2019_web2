...
if ($_COOKIE['tablename']=="caicaicms_zxclass"){
$TitleClass="资讯";$TemplateFileName='zx';
}elseif($_COOKIE['tablename']=="caicaicms_zsclass"){
$TitleClass=channelzs."/".channeldl;$TemplateFileName='zs';
}elseif($_COOKIE['tablename']=="caicaicms_askclass"){
$TitleClass="问答";$TemplateFileName='ask';
}elseif($_COOKIE['tablename']=="caicaicms_specialclass"){
$TitleClass="专题";$TemplateFileName='special';
}elseif($_COOKIE['tablename']=="caicaicms_jobclass"){
$TitleClass="招聘";$TemplateFileName='job';
}elseif($_COOKIE['tablename']=="caicaicms_userclass"){
...
$skin=$_POST["skin"][0]."|".$_POST["skin"][1];
	...
	if ($classname<>$oldclassname) {//类名改变的情况下
		...
		if ($_COOKIE['tablename']=='caicaicms_zxclass' || $_COOKIE['tablename']=='caicaicms_specialclass' ){//专题表和资讯表中有classname其它没有
		query("Update `caicaicms_".$TemplateFileName."` set bigclassname='" . $classname . "'  where bigclassid='" . $classid . "' ");
		}
...
if ($description==""){$description=$classname;}
	...
	query("Update `caicaicms_".$TemplateFileName."` set bigclassid='".$bigclassid."' where bigclassid='".$oldbigclassid."' and smallclassid='" .$classid ."'");
	
	if ($_COOKIE['tablename']=='caicaicms_zxclass' || $_COOKIE['tablename']=='caicaicms_specialclass' ){//专题表和资讯表中有classname其它没有
	query("Update `caicaicms_".$TemplateFileName."` set bigclassname=(select classname from `".$_COOKIE['tablename']."` where classid='".$bigclassid."')
	...
	if ($classname<>$oldclassname) {//小类名改变的情况下
		if ($_COOKIE['tablename']=='caicaicms_zxclass' || $_COOKIE['tablename']=='caicaicms_specialclass' ){//专题表和资讯表中有classname其它没有
		query("Update `caicaicms_".$TemplateFileName."` set smallclassname='".$classname ."' where bigclassid='".$bigclassid."' and smallclassid='".$classid ."'");
		}
	}
