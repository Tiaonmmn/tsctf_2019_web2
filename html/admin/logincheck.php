...
$sql = "select * from caicaicms_admin where admin='" .$admin. "' and pass='". $pass ."'";
	$rs = query($sql);
...
//记录登录次数
	...
	query("delete from caicaicms_login_times where sendtime<'".date("Y-m-d",strtotime("-30 day"))."'");//登录成功后，清理30天之前的无用记录
	$sql="update caicaicms_admin set showlogintime=lastlogintime,showloginip=loginip,logins=logins+1,
