...
$isok=query("insert into caicaicms_zx
...
$isok=query("update caicaicms_zx set bigclassid='$bigclassid',bigclassname='$bigclassname',smallclassid='$smallclassid',smallclassname='$smallclassname',
...
$sql="select classid,classname from caicaicms_zxclass where parentid='" .$_COOKIE["zxbigclassid"]."' order by xuhao asc";
$rs=query($sql);
while($row = fetch_array($rs)){
?>
...
checkid($id,1);
$rszx = query("select * from caicaicms_zx where id='$id'");
