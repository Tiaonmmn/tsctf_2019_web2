...
<div style="height:45px;background:#337ABB url('image/manage_top_bg.png'); ">
	...
	<div id="tabs">
		<ul>
			...
			<li><a href="class2.php?tablename=caicaicms_zsclass" onmouseover="parent.frmleft.disp(2);" target="frmright"><span>类别</span></a></li>
...
<div class="userbar">
 <?php $rs=query("select groupname from caicaicms_admingroup where id=(select groupid from caicaicms_admin where admin='".@addslashes($_COOKIE["admin"])."')");
	  $row= fetch_array($rs);
	  echo "您好<b>".@$_COOKIE["admin"]."</b>(" .$row["groupname"].")";
	  ?>
        [ <a href="/index.php" target="_top">返回首页</a> | <a href="loginout.php" target="_top">安全退出</a> 
        ] [ <a href="http://www.caicaicms.net/help.asp" target="_blank">操作说明</a> ]
</div>
