...
WriteErrMsg($msg);
	...
	$isok=query("insert into caicaicms_dl(classid,cpid,cp,province,city,content,company,companyname,dlsname,tel,address,email,sendtime)
	...
	$isok=query("update caicaicms_dl set classid='$classid',cp='$cp',province='$province',city='$city',content='$content',company='$dlsf',companyname='$companyname',
...
<form action="?do=save" method="post" name="myform" id="myform" onSubmit="return CheckForm();">      
  <table width="100%" border="0" cellpadding="3" cellspacing="0">
	...
	$row=num_rows($rs);
		if (!$row){
		echo "<a href='class2.php?tablename=caicaicms_zsclass'>添加类别</a>";
		}else{
	  ?>
	   <select name="classid">
