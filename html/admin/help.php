...
if ($_REQUEST["action"]=="add"){
	query("INSERT INTO caicaicms_help (classid,title,content,img,elite,sendtime)VALUES('$b','$title','$content','$img','$elite','".date('Y-m-d H:i:s')."')");
	}elseif ($_REQUEST["action"]=="modify"){
	query("update caicaicms_help set classid='$b',title='$title',content='$content',img='$img',elite='$elite',sendtime='".date('Y-m-d H:i:s')."' where id='$id' ");
}
...
<?php
$sql="select * from caicaicms_help where id='$id'";
$rs=query($sql);
$row=fetch_array($rs);
?>
<form action="?do=save" method="post" name="myform" id="myform" onSubmit="return CheckForm();">  
