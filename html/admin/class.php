...
if ($_COOKIE['tablename']=="caicaicms_zhclass"){
$title="展会";
}elseif($_COOKIE['tablename']=="caicaicms_linkclass"){
$title="友情链接";
}elseif($_COOKIE['tablename']=="caicaicms_wangkanclass"){
$title="网刊";
}
...
if ($action=="modify"){
	...
	if ($_COOKIE['tablename']=='caicaicms_adclass' && $bigclassname!=$oldbigclassname){
	query("update caicaicms_ad set bigclassname='$bigclassname' where bigclassname='$oldbigclassname' ");
	}
