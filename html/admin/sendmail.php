...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr>
      ...
      <td class="border"><select name="groupid">
        <?php
			$rsn=query("select * from caicaicms_usergroup order by groupid asc");
			$r=num_rows($rsn);
			if ($r){
    ...
    <tr> 
      ...
      <td class="border"> <textarea name="mailbody" id="mailbody"> </textarea>
	    ...
	    <br>
	    注：如果邮件中上传有本地图片，要在把图片地址改为绝对地址，即在形如src=&quot;/uploadfiles&quot;前面加上你的网址。如：src=&quot;<span class="STYLE2">http://demo.caicaicms.net</span>/uploadfiles&quot;</td>
    </tr>
    <tr> 
