...
$sql="select count(*) as total from caicaicms_baojia where passed<>0 ";
...
$sql="select id,cp,truename,province,city,xiancheng,price,danwei,tel,sendtime from caicaicms_baojia where passed=1 ";
