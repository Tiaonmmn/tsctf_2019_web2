...
$bigclassname="";
if ($b<>''){
$sql="select classid,classname from caicaicms_zsclass where classzm='".$b."'";
$rs=query($sql);
$row=fetch_array($rs);
...
$sql="select id,cp,truename,province,city,xiancheng,price,danwei,tel,sendtime from caicaicms_baojia where passed<>0 ";
