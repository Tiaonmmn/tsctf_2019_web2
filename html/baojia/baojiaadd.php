...
if ($cp<>'' && $truename<>'' && $tel<>''){
$isok=query("Insert into caicaicms_baojia(classzm,cp,province,city,xiancheng,price,companyname,truename,tel,address,email,sendtime,editor) values('$classid','$cp','$province','$city','$xiancheng','$price','$companyname','$truename','$tel','$address','$email','".date('Y-m-d H:i:s')."','".@$_COOKIE["UserName"]."')") ;
}  
if ($isok){
