...
if ($bigclass<>"A"){
$sql="select * from caicaicms_zsclass where classzm='".$bigclass."'";
$rs=query($sql);
$row=fetch_array($rs);
if ($row){
...
if ($smallclass<>"A"){
$sql="select * from caicaicms_zsclass where classzm='".$smallclass."'";
$rs=query($sql);
$row=fetch_array($rs);
if ($row){
...
$sql="select count(*) as total from caicaicms_main where editor='".$editor."' and passed=1 ";
$sql2='';
if ($bigclass!='A'){
...
$sql=" select * from caicaicms_main where editor='".$editor."' and passed=1 ";
$sql=$sql.$sql2;
