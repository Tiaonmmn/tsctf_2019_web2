...
if ($b<>"") {
	$sql="select count(*) as total from caicaicms_dl where classid=$bigclassid ";
}else{
...
if ($b<>"") {
$sql="select id,cp,dlsname,province,city,xiancheng,content,tel,sendtime,saver from caicaicms_dl where classid=$bigclassid ";
}else{
$sql="select id,cp,dlsname,province,city,xiancheng,content,tel,sendtime,saver from caicaicms_dl where passed=1 ";
}
$sql=$sql.$sql2;
