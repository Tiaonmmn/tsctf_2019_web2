...
$sql="select count(*) as total from caicaicms_licence where editor='".$username."' ";
$rs = query($sql); 
$row = fetch_array($rs);
$totlenum = $row['total'];
$totlepage=ceil($totlenum/$page_size);

$sql="select * from caicaicms_licence where editor='".$username."' ";
...
<input name="submit"  type="submit" class="buttons"  value="删除" onClick="return ConfirmDel()" >
		...
		<input name="tablename" type="hidden" id="tablename" value="caicaicms_licence">
</div>
</form>
<?php
}
