...
if($action=="modify"){
query("update caicaicms_usersetting set skin_mobile='$skin' where username='".$username."'");
...
<tr>        
<?php 
$rs=query("select skin_mobile from caicaicms_usersetting where username='".$username."'");
$row=fetch_array($rs);					
$fp=caicaicmsroot."skin";
