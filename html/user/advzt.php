...
if ($_POST["action"]=="add"){
$isok=query("Insert into caicaicms_ztad(classname,title,link,img,editor,passed) values('$classname','$title','$link','$img','$username',1)");
$id=insert_id();		
}elseif ($_POST["action"]=="modify"){
$id=$_POST["id"];
$isok=query("update caicaicms_ztad set classname='$classname',title='$title',link='$link',img='$img',editor='$username',passed=1 where id='$id'");
}
passed("caicaicms_ztad");
?>
...
$sqlzx="select * from caicaicms_ztad where id='$id'";
$rszx =query($sqlzx); 
