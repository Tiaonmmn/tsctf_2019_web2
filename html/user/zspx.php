...
$sql="select xuhao,id from caicaicms_main where editor='".$username."'";
$rs = query($sql); 
...
query("update caicaicms_main set xuhao=$xuhao where id=".$row['id']."");
}
}
?>
<div class="content">
<div class="admintitle"><?php echo channelzs?>信息排序</div>
 <?php
$sql="select * from caicaicms_main where editor='".$username."' order by xuhao desc";
$rs = query($sql); 
?>
