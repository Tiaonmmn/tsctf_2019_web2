...
$sql="select count(*) as total from caicaicms_wangkan where editor='".$username."' ";
$sql2='';
if ($keyword<>''){
...
$sql="select id,title,img,sendtime,passed from caicaicms_wangkan  where editor='".$username."'";
$sql=$sql.$sql2;
...
<input name="tablename" type="hidden" id="tablename" value="caicaicms_wangkan">
</div>
</form>
<?php
}
