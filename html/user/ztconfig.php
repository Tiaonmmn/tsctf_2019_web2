...
$isok=query("update caicaicms_usersetting set comanestyle='$comanestyle',comanecolor='$comanecolor',daohang='$daohang',bannerbg='$bannerbg',bannerheight='$bannerheight',tongji='$tongji',baidu_map='$baidu_map' where username='".$username."'");
...
$rs=query("select * from caicaicms_usersetting where username='".$username."'");
$row=num_rows($rs);
if(!$row){
query("INSERT INTO caicaicms_usersetting (username,skin,daohang)VALUES('".$username."','blue1','网站首页, 招商信息, 公司简介, 资质证书, 联系方式, 在线留言')");//如不存在自动添加
