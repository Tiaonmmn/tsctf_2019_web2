...
$sql="select count(*) as total from caicaicms_baojia where editor='".$username."' ";
$sql2='';
if ($cpmc<>''){
...
$sql="select id,cp,price,danwei,province,city,xiancheng,passed,sendtime from caicaicms_baojia where editor='".$username."' ";
$sql=$sql.$sql2;
...
<?php echo showpage()?>     
		...
		<input name="tablename" type="hidden" id="tablename" value="caicaicms_baojia">
</div>
  </form>
<?php
}
