...
<div class="right">
 <?php
$sql="select * from caicaicms_message where sendto='' or  sendto='".@$username."'  order by id desc";
$rs=query($sql);
$row=num_rows($rs);
if($row){
...
<?php
$sql="select id from caicaicms_dl where saver='".@$username."' and looked=0 and del=0 and passed=1";
$rs=query($sql);
$row=num_rows($rs);
if($row){
?>
...
$sql="select id from caicaicms_guestbook where saver='".@$username."' and looked=0 and passed=1";
$rs=query($sql);
$row=num_rows($rs);
if($row){
?>
