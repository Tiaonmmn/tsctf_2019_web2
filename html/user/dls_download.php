...
if (strpos($id,",")!==false){
$sql="select * from caicaicms_dl where passed=1 and saver='".$username."' and id in (". $id .") order by id desc";
}else{
$sql="select * from caicaicms_dl where passed=1 and saver='".$username."' and id='$id' ";
}	
$rs=query($sql);
