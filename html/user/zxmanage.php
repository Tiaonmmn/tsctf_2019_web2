...
$sql="select count(*) as total from caicaicms_zx where editor='".$username."' ";
$sql2='';
if ($bigclassid!=0){
...
$sql="select id,bigclassid,smallclassid,bigclassname,smallclassname,title,img,passed,hit from caicaicms_zx where editor='".$username."' ";
$sql=$sql.$sql2;
...
<input name="tablename" type="hidden" id="tablename" value="caicaicms_zx">
</div>
  </form>
<?php
}
