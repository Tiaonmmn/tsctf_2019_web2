...
$sql="select count(*) as total from caicaicms_dl where passed=1 and del=0 and saver='".$username."' ";
$sql2='';
if ($lxr<>"") {
...
$sql="select * from caicaicms_dl where passed=1 and del=0 and saver='".$username."' ";
$sql=$sql.$sql2;
