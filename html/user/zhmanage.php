...
$sql="select count(*) as total from caicaicms_zh where editor='".$username."' ";
$sql2='';
if ($keyword<>''){
...
$sql="select id,title,sendtime,passed from caicaicms_zh  where editor='".$username."'";
$sql=$sql.$sql2;
...
<input name="tablename" type="hidden" id="tablename" value="caicaicms_zh">
</div>
</form>
<?php
}
