...
$sql="select count(*) as total from caicaicms_dl where editor='".$username."' ";
$sql2='';
if ($cpmc<>''){
...
$sql="select id,cp,dlsname,province,city,xiancheng,saver,passed,sendtime,looked from caicaicms_dl where editor='".$username."' ";
$sql=$sql.$sql2;
...
<?php echo showpage()?>     
		...
		<input name="tablename" type="hidden" id="tablename" value="caicaicms_dl">
</div>
  </form>
<?php
}
