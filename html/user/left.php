...
$sql_left="select classid from caicaicms_zxclass where classname='公司新闻' ";
...
$sql_left="select id from caicaicms_dl where saver='".@$username."' and looked=0 and del=0 and passed=1";
$rs_left=query($sql_left);
...
$sql_left="select id from caicaicms_guestbook where saver='".@$username."' and looked=0 and passed=1";
$rs_left=query($sql_left);
$row_left=num_rows($rs_left);
if($row_left){
echo "<span class='buttons'>".$row_left."</span>";
