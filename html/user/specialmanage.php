...
$sql="select count(*) as total from caicaicms_special where editor='".$username."' ";
$sql2='';
if ($bigclassid!=""){
checkid($bigclassid);
...
$sql="select * from caicaicms_special where editor='".$username."' ";
$sql=$sql.$sql2;
...
<input name="tablename" type="hidden" id="tablename" value="caicaicms_special">
</div>
  </form>
<?php
}
