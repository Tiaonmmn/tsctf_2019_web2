...
$sql="select count(*) as total from caicaicms_pp where editor='".$username."' ";
$sql2='';
if (isset($cpmc)){
...
$sql="select * from caicaicms_pp where editor='".$username."' ";
$sql=$sql .$sql2;	
...
<?php echo showpage()?> 
          ...
          <input name="tablename" type="hidden" id="tablename" value="caicaicms_pp" />
        </div>
</form>
<?php
}
