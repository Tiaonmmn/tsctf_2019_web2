...
$sql="select count(*) as total from caicaicms_ztad where editor='".$username."' ";
$sql2='';
...
$sql="select id,classname,title,img,passed from caicaicms_ztad where editor='".$username."' ";
$sql=$sql.$sql2;
...
<input name="tablename" type="hidden" id="tablename" value="caicaicms_ztad">
</div>
  </form>
<?php
}
