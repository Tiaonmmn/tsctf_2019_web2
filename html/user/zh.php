...
$isok=query("Insert into caicaicms_zh(bigclassid,title,address,timestart,timeend,content,editor,sendtime) values('$bigclassid','$title','$address','$timestart','$timeend','$content','$username','".date('Y-m-d H:i:s')."')") ;
$id=insert_id();
		
}elseif ($_POST["action"]=="modify"){
$isok=query("update caicaicms_zh set bigclassid='$bigclassid',title='$title',address='$address',timestart='$timestart',timeend='$timeend',content='$content',
...
function add(){
$tablename="caicaicms_zh";//checkaddinfo中用
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="1">
          <tr> 
            ...
            <td width="85%" class="border2"> <select name="bigclassid" id="bigclassid" class="biaodan">
                ...
                <?php  
		$rs=query("select classid,classname from caicaicms_zhclass");
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="1">
          <tr> 
            ...
            <td width="85%" class="border2"> <select name="bigclassid" id="bigclassid" class="biaodan">
                <option value="" selected="selected">请选择类别</option>
                <?php
		$sqln="select classid,classname from caicaicms_zhclass";
		$rsn=query($sqln);
