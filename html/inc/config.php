<?php
define('sqldb','caicaicms');//数据库名
define('sqluser','tsctf');//用户名
define('sqlpwd','tsctf');//密码
define('sqlhost','localhost');//连接服务器,本机填localhost，外地填IP地址
define('sqlport','3306');//端口（默认为:3306）
define('caicaicmsver','Powered By <a target=_blank style="font-weight:bold;letter-spacing:1px;text-shadow:-1px 0 #FFF,0 1px #FFF,1px 0 #FFF,0 -1px #FFF;" href=http://www.caicaicms.net><font color=#FF6600 face=Arial>CAICAI</font><font color=#025BAD face=Arial>CMS2019</font></a>');//版本
define('sitename','caicaicms') ;//网站名称
define('siteurl','https://nicaicai:8888') ;//网站地址
define('logourl','http://127.0.0.1:8888/image/logo.png') ;//Logo地址
