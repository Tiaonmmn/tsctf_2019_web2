...
$i=1;
$sql= "select * from caicaicms_ad where bigclassname='".$b."' and smallclassname='".$s."' ";
...
$sql= "select * from caicaicms_ad where bigclassname='".$b."' and smallclassname='".$leftclassname."' ";
if (isshowad_when_timeend=="No"){
$sql=$sql. "and endtime>= '".date('Y-m-d H:i:s')."' ";
}
...
$sql= "select * from caicaicms_ad where bigclassname='".$b."' and smallclassname='".$rightclassname."' ";
if (isshowad_when_timeend=="No"){
$sql=$sql. "and endtime>= '".date('Y-m-d H:i:s')."' ";
}
$sql=$sql. "order by xuhao asc";
