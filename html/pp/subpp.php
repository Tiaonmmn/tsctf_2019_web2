...
if($row['classzm']==$b){$str=$str."<li class='current'>";}else{$str=$str."<li>";}
	...
	//$rsnumb=query("select id from caicaicms_pp where bigclasszm='".$row["classzm"]."' ");//统计所属大类下的信息数
...
$cpid=isset($cs[10])?$cs[10]:'no';
	$sql="select id,ppname,img,sendtime,passed,hit from caicaicms_pp where passed=1 ";
