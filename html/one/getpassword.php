...
checkyzm($_POST["yzm"]);
$rs=query("select mobile,email from caicaicms_user where username='" . $username . "' ");
$row=fetch_array($rs);
...
query("update caicaicms_user set password='$password',passwordtrue='$passwordtrue' where username='".@$_SESSION['username']."'");
